...
Using Rmarkdown is an excellent way to work.  It enables you to bring together the data, the exploratory visualisation, the statistical modelling, the explanatory visualisation and the reporting into a single document that is easily updatable with version control, easy to use for presenting and discussing, and gives you the ability to make into a nice shiny document as an html or pdf. Brilliant.  I love it.

Visualisation is super useful for exploration.  I need to improve my ggplot skills, and think more about how to use visualisation for explanation too.

Make the statistical modelling work for you.  Think about it from the perspective of supporting your data to answer the questions you are interested in, rather than it being an excerise to get p values, or going through the motions of looking at every bit of data you have and aimlessly identifying differences.
